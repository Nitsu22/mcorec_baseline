    ...
    def __init__(self, subset):
        if subset == "train":
            self.video_pipeline = torch.nn.Sequential(
                ...
                torchvision.transforms.Resize((88, 88)),  # Changed from RandomCrop(88) to Resize for 224x224 face videos
            ...
            self.video_pipeline = torch.nn.Sequential(
                FunctionalModule(lambda x: x / 255.0),
                torchvision.transforms.Resize((88, 88)),  # Changed from CenterCrop(88) to Resize for 224x224 face videos
                torchvision.transforms.Normalize(0.421, 0.165),
            )

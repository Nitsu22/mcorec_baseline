from src.nets.backend.e2e_asr_avhubert_sep_roland import E2E
...
class AVHubertAVSR(PreTrainedModel):
    ...
    def forward(self, 
        ...
        loss, loss_ctc, loss_att, loss_sep, acc = self.avsr(videos, audios, video_lengths, audio_lengths, labels, label_audios, label_noises, label_audio_lengths, label_noise_lengths)

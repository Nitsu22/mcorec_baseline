...
class seanet(nn.Module):
    def __init__(self, N = 256, L = 40, B = 64, H = 128, K = 100, R = 3, visual_dim = 1024):
        '''
        ...
        self.separator = Extractor(N, L, B, H, K, R, visual_dim=visual_dim)
...
class Extractor(nn.Module):
    def __init__(self, N, L, B, H, K, R, visual_dim=1024):
        '''
        ...
        self.v_ds               = nn.Linear(visual_dim, N, bias=False)
        stacks = []
        for x in range(5):
...
class seanet_separator(seanet):
    def __init__(self, N = 256, L = 40, B = 64, H = 128, K = 100, R = 3, visual_dim = 1024):
        super().__init__(N=N, L=L, B=B, H=H, K=K, R=R, visual_dim=visual_dim)

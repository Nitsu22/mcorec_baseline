...
from src.dataset.avhubert_dataset_sep import load_audio, load_video, cut_or_pad, AudioTransform, VideoTransform, DataCollator
from src.tokenizer.spm_tokenizer import TextTransform
from src.avhubert_avsr.avhubert_avsr_model_sep import AVHubertAVSR, get_beam_search_decoder
...
def load_avsr_dataset(cache_dir='data-bin/cache', include_mcorec=True, streaming=False):
    ...
    while not finished_loading:
        try:
            ...
            lrs2 = datasets.load_dataset("nguyenvulebinh/AVYT", "lrs2", streaming=streaming, data_files={
                "train": "/gs/bs/tga-shinoda/phuong/datasets_storage/chime9_dataset/AVYT/lrs2/lrs2-train-*.tar",
                "pretrain": "/gs/bs/tga-shinoda/phuong/datasets_storage/chime9_dataset/AVYT/lrs2/lrs2-pretrain-*.tar",
                "valid": "/gs/bs/tga-shinoda/phuong/datasets_storage/chime9_dataset/AVYT/lrs2/lrs2-valid-*.tar",
                "test_snr_0_interferer_2": "/gs/bs/tga-shinoda/phuong/datasets_storage/chime9_dataset/AVYT/lrs2/lrs2-test_snr_0_interferer_2-*.tar",
            }).remove_columns(['__key__', '__url__'])
            vox2 = datasets.load_dataset("nguyenvulebinh/AVYT", "vox2", streaming=streaming, data_files={
                "dev": "/gs/bs/tga-shinoda/phuong/datasets_storage/chime9_dataset/AVYT/vox2/vox2-dev-*.tar",
            }).remove_columns(['__key__', '__url__'])
            avyt = datasets.load_dataset("nguyenvulebinh/AVYT", "avyt", streaming=streaming, data_files={
                "talking": "/gs/bs/tga-shinoda/phuong/datasets_storage/chime9_dataset/AVYT/avyt/talking-*.tar",
                "silent":  "/gs/bs/tga-shinoda/phuong/datasets_storage/chime9_dataset/AVYT/avyt/silent-*.tar",
            }).remove_columns(['__key__', '__url__'])
            avyt_mix = datasets.load_dataset("nguyenvulebinh/AVYT", "avyt-mix", streaming=streaming, data_files={
                "train": "/gs/bs/tga-shinoda/phuong/datasets_storage/chime9_dataset/AVYT/dialog/dialog-train-*.tar",
                "test":  "/gs/bs/tga-shinoda/phuong/datasets_storage/chime9_dataset/AVYT/dialog/dialog-test-*.tar",
            }).remove_columns(['__key__', '__url__'])
            ...
            if include_mcorec:
                ...
                mcorec_dataset = datasets.load_dataset("MCoRecChallenge/MCoRec", streaming=streaming, data_files={
                    "train": "/gs/bs/tga-shinoda/phuong/datasets_storage/chime9_dataset/MCoRec/processed/mcorec-train-*.tar",
                    "valid":  "/gs/bs/tga-shinoda/phuong/datasets_storage/chime9_dataset/MCoRec/processed/mcorec-valid-*.tar",
                }).remove_columns(['__key__', '__url__'])
    ...
    interference_speech = datasets.load_dataset("nguyenvulebinh/AVYT", "lrs2", cache_dir=cache_dir, data_files='/gs/bs/tga-shinoda/phuong/datasets_storage/chime9_dataset/AVYT/lrs2/lrs2-train-*.tar').remove_columns(['__key__', '__url__'])['train']
